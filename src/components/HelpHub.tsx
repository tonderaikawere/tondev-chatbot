        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-[#0B132B]/50 leading-relaxed text-xs sm:text-sm text-slate-300">
          ...
          {activeTab === 'compliance' && (
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-xs sm:text-sm">
                <section className="space-y-2">
                  <h4 className="font-bold text-white text-xs uppercase tracking-wider text-blue-400 font-semibold">1. AI Content & Professional Services Disclaimer</h4>
                  <p>
                    The outputs provided by our AI Mentors are intended strictly for educational, informational, and coding support purposes:
                  </p>
                  <ul className="list-disc pl-5 space-y-1 text-slate-400 text-xs">
                    <li><strong>No Professional Advice</strong>: AI Mentor recommendations do not constitute official system administration, legal advice, cybersecurity audits, or professional medical/financial counseling.</li>
                    <li><strong>Critical Systems Warning</strong>: Do not deploy AI-generated scripts directly onto live healthcare, defense, transportation, or high-risk banking systems without secondary human validation.</li>
                    <li><strong>Liability Limits</strong>: Tonde Kawere and Kawerify Tech are completely immune to damages resulting from reliance on advice generated by the LLM engines.</li>
                  </ul>
                </section>

                <section className="space-y-2 border-t border-[#1C2541] pt-4">
                  <h4 className="font-bold text-white text-xs uppercase tracking-wider text-blue-400 font-semibold">2. DMCA & Copyright Infringement Claims</h4>
                  <p>
                    We respect the intellectual property rights of others. The 90 offline training modules in our library are curated educational guides summarizing industry concepts:
                  </p>
                  <p className="text-slate-400 text-xs">
                    If you believe that any material within the Offline Library infringes upon your copyright, you may submit a written DMCA takedown notice containing:
                  </p>
                  <ul className="list-disc pl-5 space-y-1 text-slate-400 text-xs">
                    <li>Identification of the copyrighted work claimed to have been infringed.</li>
                    <li>Specific identification of the module name and content block to be removed.</li>
                    <li>Your contact info (email address and phone number).</li>
                    <li>A statement that you have a good faith belief that the use is unauthorized.</li>
                  </ul>
                  <p className="text-slate-400 text-xs">
                    Send DMCA complaints to our copyright agent via the contact forms at <a href="https://kawerifytech.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">kawerifytech.com</a>.
                  </p>
                </section>

                <section className="space-y-2 border-t border-[#1C2541] pt-4">
                  <h4 className="font-bold text-white text-xs uppercase tracking-wider text-blue-400 font-semibold">3. GDPR & CCPA Compliance (Data Privacy Rights)</h4>
                  <p>
                    Even though this application is local-first and does not collect your data on a central database, we fully comply with global data protection standards:
                  </p>
                  <ul className="list-disc pl-5 space-y-1 text-slate-400 text-xs">
                    <li><strong>Right to Erasure (Right to be Forgotten)</strong>: You have total control to completely delete all chat history, account data, and saved settings by selecting "Clear Browser Data" or clicking the logout option.</li>
                    <li><strong>Right to Portability</strong>: You can extract your data at any time directly from the browser's IndexedDB/LocalStorage.</li>
                    <li><strong>No Sale of Personal Data</strong>: We do not track, profile, share, or sell user metadata or conversational prompts to any third-party advertising companies.</li>
                  </ul>
                </section>

                <section className="space-y-2 border-t border-[#1C2541] pt-4">
                  <h4 className="font-bold text-white text-xs uppercase tracking-wider text-blue-400 font-semibold">4. Browser Local Storage & Cookie Policy</h4>
                  <p>
                    This application does not use tracking cookies. We utilize browser-native storage technologies to enable offline capabilities:
                  </p>
                  <ul className="list-disc pl-5 space-y-1 text-slate-400 text-xs">
                    <li><strong>LocalStorage</strong>: Used to save your active user session, UI preferences, theme mode, and AI Brain endpoint settings.</li>
                    <li><strong>IndexedDB</strong>: Used to store chat transcripts offline, allowing instant retrieval during offline periods.</li>
                  </ul>
                  <p className="text-slate-400 text-xs">
                    By using this application, you consent to the storage of this on-device technical data.
                  </p>
                </section>
              </div>
            </div>
